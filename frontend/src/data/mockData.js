// Mock data ported from the TypeScript version for landlord flows
...
export const mockProperties = [
  {
    ...
    description:
      'Fully furnished studio with stunning city views. Walking distance to Pavilion and KLCC. 24-hour security, swimming pool, and gym facilities included.',
  ...
  },
  {
    ...
    description:
      'Spacious 2-bedroom unit with modern finishes. Near LRT station and The Sphere. Perfect for young professionals or small families.',
  ...
  },
  {
    ...
    description:
      '3-bedroom family home with garden. Quiet neighborhood, near international schools. Fully renovated with new kitchen appliances.',
  ...
  },
  {
    ...
    description:
      'Single room in shared apartment. Ideal for students or working professionals. Near public transport and amenities.',
  ...
  },
  {
    ...
    description:
      'Exclusive penthouse with panoramic views. Private lift access, premium finishes throughout. Smart home features included.',
  ...
  },
  {
    ...
    description:
      'Modern apartment in a gated community. Close to universities and tech hubs. Perfect for families with children.',
  ...
  },
  {
    ...
    description:
      'Affordable 2-bedroom unit with balcony. Near IOI Mall and LRT station. Good for working professionals.',
...
export const mockRentalHistories = {
  '950101-01-1234': [
    {
      id: 'history-1',
