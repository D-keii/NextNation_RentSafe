    ...
    return(
        <div className="bg-white border-1 w-fit rounded-lg overflow-hidden" >
            ...
            <div className="p-3 flex flex-col space-y-2">
                ...
                <button className="flex flex-row border-1 w-full items-center justify-center p-2 rounded-md bg-muted cursor-pointer hover:bg-accent hover:text-white">View Details <ArrowRight className="ml-2"/></button>
            </div>
        </div>
    )
}